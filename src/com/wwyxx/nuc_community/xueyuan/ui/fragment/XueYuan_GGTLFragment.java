...
public class XueYuan_GGTLFragment extends Fragment implements OnClickListener {
	...
	private void init() {
		...
		listView = (ListView) getActivity()
				.findViewById(R.id.listView_all_ggtl);
		...
		query.addWhereEqualTo("tagString", NUC_CMD.NUC_GGTL_X_7);
		BmobQuery<GGTLBean> query1 = new BmobQuery<GGTLBean>();
		query1.addWhereEqualTo("Pnode", null);
		//////////////////////////////////////////////////////
		query.setLimit(50);
		query.findObjects(getActivity(), new FindListener<GGTLBean>() {
			...
			public void onSuccess(List<GGTLBean> arg0) {
				...
				mArrayAdapter = new ArrayAdapter<>(getActivity()
						...
						android.R.layout.simple_list_item_1, titlelList);
	...
	protected void submitGGTL(String string, String string2) {
		...
		ggtl.setTagString(NUC_CMD.NUC_GGTL_X_7);
